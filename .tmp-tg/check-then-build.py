...
run("pm2 status")
run("systemctl is-active pulse-auto-update.timer; systemctl is-active pulse-auto-update.service")
run("tail -n 15 /var/log/pulse-auto-update.log 2>/dev/null || echo NO_LOG")
run(
    "cd /root/pulse-chat && git fetch origin master && "
