...
git clean -fd --exclude=data --exclude=uploads --exclude=.env --exclude=.giphy-api-key --exclude=.groq-api-key --exclude=.groq-proxy-url --exclude=.groq-bridge-secret --exclude=.livekit-url --exclude=.livekit-api-key --exclude=.livekit-api-secret --exclude=.livekit-server.yaml --exclude=.turn-user --exclude=.turn-pass
